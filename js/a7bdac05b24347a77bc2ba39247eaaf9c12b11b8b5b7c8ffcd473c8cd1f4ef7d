!(function () {
  ...
  class n {
    ...
    onWindowResize() {
      ...
      this.items.forEach((e) => {
        ...
        (!e.executed ||
          (n && e.options.runOnWidthChange) ||
          (o && e.options.runOnHeightChange)) &&
          t();
      }),
    ...
    runOnResize(e, n) {
      this.items.push({ callback: e, options: n, executed: n.runOnLoad }),
  ...
  function o(t, o, i = e) {
    ...
    (window.canva_debounceResize =
      null !== (a = window.canva_debounceResize) && void 0 !== a
        ? a
        : new n(i)).runOnResize(t, {
      runOnLoad: !1,
      runOnWidthChange: !0,
      runOnHeightChange: !1,
  ...
  !(function () {
    ...
    e.forEach((e) => {
      e.dataset.playbackRate &&
        (e.playbackRate = parseFloat(e.dataset.playbackRate) || 1);
      const o = {},
        { maybeResetVideoProgress: i, videoStart: a } = (function (e, t) {
          ...
          (e.currentTime = i),
            e.loop && i > 0 && ((e.dataset.loop = "true"), (e.loop = !1));
          e.addEventListener("timeupdate", () => {
            const t = e.currentTime;
            let n;
            null != a && t >= a - (r ? 0.25 : 0)
              ? e.loop || e.dataset.loop
                ? ((n = i), e.play())
                : e.pause()
              : t < i && (n = i),
          ...
          return { maybeResetVideoProgress: d, videoStart: i };
        })(e, o);
      e.autoplay
        ? ((e.autoplay = !1), e.paused || e.pause(), n.observe(e))
        : (function (e, t) {
      ...
      const s = (function (e, t, n, o) {
        ...
        const r =
            null !== (i = e.closest(".video_container")) && void 0 !== i
              ? i
              : (null !== (a = e.closest("svg")) && void 0 !== a
                  ? a
                  : e
                ).closest("div"),
          ...
          (function (e, t) {
            ...
            e.addEventListener("volumechange", r),
              ...
              n.addEventListener("click", () => {
                e.muted
                  ? ((e.muted = !1), (e.volume = a))
                  : (e.volume = e.volume > 0 ? 0 : a);
              });
          })(e, l);
        const { playButton: u, playPause: p } = (function (e, t) {
            ...
            r = async (o) => {
              ...
              try {
                e.paused
                  ? (t(),
                    e.muted &&
                      ((e.volume = a), 0 !== e.volume && (e.muted = !1)),
          ...
          return (
            i.addEventListener("click", r), { playButton: i, playPause: r }
          );
        })(e, t);
        d.appendChild(u);
      ...
      !(function (e) {
        ...
        for (const e of a)
          if (window.matchMedia(e.media).matches) {
            r =
              (parseFloat(e.width.replace("vw", "")) / 100) *
        ...
        e.setAttribute(
          "src",
          null === (t = o[o.length - 1]) || void 0 === t ? void 0 : t.url
        );
      })(e);
    }),
      o(() => t.forEach((e) => e()), { runOnLoad: !0 });
  })();
})();
